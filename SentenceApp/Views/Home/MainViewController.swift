...
class MainViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func addOffence2(_ sender: UIButton) {
        ...
        if(offence2View.tag == 1){
            ...
            showMessage(message: "Something went wrong with addOffence2 action.", controller: self)
        }
    }
    ...
    @IBAction func addOffence3(_ sender: UIButton) {
        ...
        // add frontend stuff
        if(offence3View.tag == 1){
            offence2View.tag = 0
            // ==================FOR TESTING==================
            offence3ViewTag = 0
            // ==================FOR TESTING==================
            print("==================Add offence 3 tag == 1==================")
            print("isOneOffence: \(isOneOffence)\n isTwoOffences: \(isTwoOffences)\n isThreeOffences: \(isThreeOffences)")
            print("offence2ViewTag: \(offence2ViewTag)")    // output: 0
            print("offence3ViewTag: \(offence3ViewTag)")    // output: 1
            print("offence2View.isHidden = false")
            print("What happened: show input for offence 3, change addOffence3Button button to remove offence")
            print("==================Add offence 3 tag == 1==================")
            
            offence3View.isHidden = false
            addOffence3Button.tintColor = UIColor.systemRed
            addOffence3Button.setTitle("Remove third offence", for: .normal)
            addOffence3Button.setImage(UIImage(systemName: "minus"), for: .normal)
        }
        else if(offence3View.tag == 0){
            offence2View.tag = 1
            // ==================FOR TESTING==================
            offence3ViewTag = 1
            // ==================FOR TESTING==================
            ...
            print("offence3ViewTag: \(offence3ViewTag)")    // output: 1
            print("offence2View.isHidden = false")
            print("What happened: hide input for offence 3, change addOffence3Button button to add offence")
            print("==================Add offence 3 tag == 1==================")
            
            offence3View.isHidden = true
            addOffence3Button.tintColor = UIColor.systemBlue
            addOffence3Button.setTitle("Add third offence", for: .normal)
            addOffence3Button.setImage(UIImage(systemName: "plus"), for: .normal)
        }
        else{
            showMessage(message: "Something went wrong with addOffence3 action.", controller: self)
        }
    }
    ...
    @IBAction func recommendOutput(_ sender: UIButton) {
        ...
        if(isOneOffence == true && isTwoOffences == false && isThreeOffences == false){
            if(validForm()){
                ...
                print("inside [isOneOffence] valid form")
                print("isOneOffence: \(isOneOffence)\nisTwoOffences: \(isTwoOffences)\nisThreeOffences: \(isThreeOffences)\n")
                print("==================FOR FRONTEND TESTING==================")
                ...
                print("sentenceProbabilityRecommend1 type: \(type(of: sentenceProbabilityRecommend1))") // Dictionary<String, Double>
